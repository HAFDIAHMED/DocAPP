...
export const AllProjectsScreen = observer(function AllProjectsScreen() {
  ...
  return (
    <Screen style={ROOT} preset="scroll">
      ...
      <ButtonProject    onPress={() => navigation.navigate("examplesPage")} textLabel="Examples" iconName={"phone-portrait"} iconColor={"black"} iconSize={40} textlabelColor={"black"}  style={{margin:5}} />
